...
gdjs.Level1Code.GDDPadRightObjects4= [];
gdjs.Level1Code.GDDPadLeftObjects1= [];
gdjs.Level1Code.GDDPadLeftObjects2= [];
gdjs.Level1Code.GDDPadLeftObjects3= [];
gdjs.Level1Code.GDDPadLeftObjects4= [];
gdjs.Level1Code.GDDPadUpObjects1= [];
gdjs.Level1Code.GDDPadUpObjects2= [];
gdjs.Level1Code.GDDPadUpObjects3= [];
gdjs.Level1Code.GDDPadUpObjects4= [];
gdjs.Level1Code.GDDPadDownObjects1= [];
gdjs.Level1Code.GDDPadDownObjects2= [];
gdjs.Level1Code.GDDPadDownObjects3= [];
gdjs.Level1Code.GDDPadDownObjects4= [];
gdjs.Level1Code.GDLinkObjects1= [];
gdjs.Level1Code.GDLinkObjects2= [];
gdjs.Level1Code.GDLinkObjects3= [];
gdjs.Level1Code.GDLinkObjects4= [];
gdjs.Level1Code.GDtopObjects1= [];
gdjs.Level1Code.GDtopObjects2= [];
gdjs.Level1Code.GDtopObjects3= [];
gdjs.Level1Code.GDtopObjects4= [];
...
gdjs.Level1Code.condition0IsTrue_0.val = false;
{
gdjs.Level1Code.condition0IsTrue_0.val = gdjs.evtTools.runtimeScene.timerElapsedTime(runtimeScene, 21, "CoinTimer");
}if (gdjs.Level1Code.condition0IsTrue_0.val) {
...
gdjs.Level1Code.condition0IsTrue_0.val = false;
{
gdjs.Level1Code.condition0IsTrue_0.val = gdjs.evtTools.runtimeScene.timerElapsedTime(runtimeScene, 19, "FloorMineTimer");
}if (gdjs.Level1Code.condition0IsTrue_0.val) {
...
};gdjs.Level1Code.mapOfGDgdjs_46Level1Code_46GDMineObjects1Objects = Hashtable.newFrom({"Mine": gdjs.Level1Code.GDMineObjects1});gdjs.Level1Code.mapOfGDgdjs_46Level1Code_46GDButtonTryAgainObjects2Objects = Hashtable.newFrom({"ButtonTryAgain": gdjs.Level1Code.GDButtonTryAgainObjects2});gdjs.Level1Code.eventsList11 = function(runtimeScene) {
...
};gdjs.Level1Code.mapOfGDgdjs_46Level1Code_46GDButtonTryAgainObjects2Objects = Hashtable.newFrom({"ButtonTryAgain": gdjs.Level1Code.GDButtonTryAgainObjects2});gdjs.Level1Code.eventsList12 = function(runtimeScene) {
...
gdjs.copyArray(runtimeScene.getObjects("DPadDown"), gdjs.Level1Code.GDDPadDownObjects1);
...
for(var i = 0, len = gdjs.Level1Code.GDDPadDownObjects1.length ;i < len;++i) {
    gdjs.Level1Code.GDDPadDownObjects1[i].hide();
}
...
gdjs.copyArray(runtimeScene.getObjects("top"), gdjs.Level1Code.GDtopObjects1);

for(gdjs.Level1Code.forEachIndex2 = 0;gdjs.Level1Code.forEachIndex2 < gdjs.Level1Code.GDtopObjects1.length;++gdjs.Level1Code.forEachIndex2) {
gdjs.Level1Code.GDtopObjects2.length = 0;


gdjs.Level1Code.forEachTemporary2 = gdjs.Level1Code.GDtopObjects1[gdjs.Level1Code.forEachIndex2];
gdjs.Level1Code.GDtopObjects2.push(gdjs.Level1Code.forEachTemporary2);
gdjs.Level1Code.condition0IsTrue_0.val = false;
{
for(var i = 0, k = 0, l = gdjs.Level1Code.GDtopObjects2.length;i<l;++i) {
    if ( gdjs.Level1Code.GDtopObjects2[i].getX() <= -((gdjs.Level1Code.GDtopObjects2[i].getWidth())) ) {
        gdjs.Level1Code.condition0IsTrue_0.val = true;
        gdjs.Level1Code.GDtopObjects2[k] = gdjs.Level1Code.GDtopObjects2[i];
        ++k;
    }
}
gdjs.Level1Code.GDtopObjects2.length = k;}if (gdjs.Level1Code.condition0IsTrue_0.val) {
{for(var i = 0, len = gdjs.Level1Code.GDtopObjects2.length ;i < len;++i) {
    gdjs.Level1Code.GDtopObjects2[i].setX((gdjs.Level1Code.GDtopObjects2[i].getWidth()));
}
}}
}
...
{
gdjs.copyArray(runtimeScene.getObjects("top"), gdjs.Level1Code.GDtopObjects1);
{for(var i = 0, len = gdjs.Level1Code.GDtopObjects1.length ;i < len;++i) {
    gdjs.Level1Code.GDtopObjects1[i].setX(gdjs.Level1Code.GDtopObjects1[i].getX() - (gdjs.evtTools.variable.getVariableNumber(runtimeScene.getVariables().getFromIndex(1))));
}
}}
...
gdjs.Level1Code.condition0IsTrue_0.val = false;
{
gdjs.Level1Code.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.Level1Code.mapOfGDgdjs_46Level1Code_46GDDPadDownObjects1Objects, runtimeScene, true, false);
}if (gdjs.Level1Code.condition0IsTrue_0.val) {
gdjs.copyArray(runtimeScene.getObjects("Submarine"), gdjs.Level1Code.GDSubmarineObjects1);
{for(var i = 0, len = gdjs.Level1Code.GDSubmarineObjects1.length ;i < len;++i) {
    gdjs.Level1Code.GDSubmarineObjects1[i].addForce(0, 200, 0);
...
gdjs.Level1Code.condition0IsTrue_0.val = false;
{
gdjs.Level1Code.condition0IsTrue_0.val = gdjs.evtTools.variable.getVariableNumber(runtimeScene.getVariables().get("Score")) > 50 + gdjs.random(5);
}if (gdjs.Level1Code.condition0IsTrue_0.val) {
...
gdjs.Level1Code.condition0IsTrue_0.val = false;
{
gdjs.Level1Code.condition0IsTrue_0.val = gdjs.evtTools.variable.getVariableNumber(runtimeScene.getVariables().get("Score")) > 25 + gdjs.random(5);
}if (gdjs.Level1Code.condition0IsTrue_0.val) {
...
gdjs.Level1Code.condition0IsTrue_0.val = false;
{
gdjs.Level1Code.condition0IsTrue_0.val = gdjs.evtTools.variable.getVariableNumber(runtimeScene.getVariables().get("Score")) > 150 + gdjs.random(5);
}if (gdjs.Level1Code.condition0IsTrue_0.val) {
...
gdjs.Level1Code.GDDPadRightObjects4.length = 0;
...
gdjs.Level1Code.GDDPadLeftObjects4.length = 0;
...
gdjs.Level1Code.GDDPadUpObjects4.length = 0;
gdjs.Level1Code.GDDPadDownObjects1.length = 0;
gdjs.Level1Code.GDDPadDownObjects2.length = 0;
gdjs.Level1Code.GDDPadDownObjects3.length = 0;
gdjs.Level1Code.GDDPadDownObjects4.length = 0;
gdjs.Level1Code.GDLinkObjects1.length = 0;
gdjs.Level1Code.GDLinkObjects2.length = 0;
gdjs.Level1Code.GDLinkObjects3.length = 0;
gdjs.Level1Code.GDLinkObjects4.length = 0;
gdjs.Level1Code.GDtopObjects1.length = 0;
gdjs.Level1Code.GDtopObjects2.length = 0;
gdjs.Level1Code.GDtopObjects3.length = 0;
gdjs.Level1Code.GDtopObjects4.length = 0;
